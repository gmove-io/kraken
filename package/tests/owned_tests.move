// can't be tested outside of a proposal
// #[test_only]
...
//         let mut withdraw = oownednew_withdraw(vector[id1, id2]);
...
//         let mut borrow = owownedew_borrow(vector[id1, id2]);
...
//     #[test]
//     #[expected_failure(abort_code = ownownedrongObject)]
...
//         let mut borrow = owneowned_borrow(vector[id1]);
...
//     #[test]
//     #[expected_failure(abort_code = ownedownedngObject)]
...
//         let mut borrow = owned:ownedorrow(vector[id1]);
...
//     #[test]
//     #[expected_failure(abort_code = owned::ownedeveAllObjectsBefore)]
...
//         let borrow = owned::nownedrow(vector[id1]);
...
//     #[test]
//     #[expected_failure(abort_code = owned::ERownedllObjectsBefore)]
...
//         let mut borrow = owned::newownedw(vector[id1]);
